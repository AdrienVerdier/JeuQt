...
Game_View_Entity *Game_View_Factory::create(Entity *e,int x)
{
    ...
    if (typeid (BlockGrass).name() == typeid(*e).name()) return create((BlockGrass*)e, x);
    ...
    if (typeid (bowser_fire).name() == typeid(*e).name()) return create((bowser_fire*)e, x);
}
...
Game_View_Entity* Game_View_Factory::create(Mario *m,int x){
          ...
          map[8].push_back(mario["8"].toArray()[0].toString());
          for(int i =0;i<6;i++)
          map[9].push_back(mario["9"].toArray()[i].toString());
          map[10].push_back(mario["10"].toArray()[0].toString());
          map[11].push_back(mario["11"].toArray()[0].toString());
          for(int i =0;i<6;i++)
          map[12].push_back(mario["12"].toArray()[i].toString());
          map[13].push_back(mario["13"].toArray()[0].toString());
...
Game_View_Entity* Game_View_Factory::create(BlockGrass *b, int x){
          ...
          QJsonDocument d = QJsonDocument::fromJson(val.toUtf8());
          QJsonObject sett2 = d.object();
          QJsonValue value = sett2.value(QString("blockGrass"));

          QJsonObject blockGrass = value.toObject();

          map[0].push_back(blockGrass["0"].toArray()[0].toString());
...
Game_View_Entity* Game_View_Factory::create(CheckPoint *t, int x){
          ...
          QJsonDocument d = QJsonDocument::fromJson(val.toUtf8());
          QJsonObject sett2 = d.object();
          QJsonValue value = sett2.value(QString("checkpoint"));

          QJsonObject checkpoint = value.toObject();

          map[0].push_back(checkpoint["0"].toArray()[0].toString());
          map[1].push_back(checkpoint["1"].toArray()[0].toString());
...
Game_View_Entity* Game_View_Factory::create(bowser_fire *g, int x){
          ...
          QJsonDocument d = QJsonDocument::fromJson(val.toUtf8());
          QJsonObject sett2 = d.object();
          QJsonValue value = sett2.value(QString("bowser_fire"));
